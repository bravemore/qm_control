...
visualization_msgs::InteractiveMarker QmTargetTrajectoriesInteractiveMarker::createInteractiveMarker() const {
    ...
    interactiveMarker.pose.position.x = 0.177;
    interactiveMarker.pose.position.y = 0;
    interactiveMarker.pose.position.z = 0.518;
    interactiveMarker.pose.orientation.x = 0;
    interactiveMarker.pose.orientation.y = 0;
    interactiveMarker.pose.orientation.z = 0;
    interactiveMarker.pose.orientation.w = 1;
